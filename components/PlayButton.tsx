...
export default function PlayButton() {
  return (
    <div className="absolute left-12 top-1/4 flex items-center space-x-4 z-40">
      <button className="w-16 h-16 rounded-full border border-brand-blue-dark/20 flex items-center justify-center hover:bg-brand-blue-dark/5 transition-colors group">
